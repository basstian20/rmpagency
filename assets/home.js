...
if (
  ...
  function anim() {
    ...
    cursorFrame = requestAnimationFrame(anim);
  }

  function startCursorFrame() {
    if (cursorFrame !== null || document.hidden || reducedMotion.matches) return;
    cursorFrame = requestAnimationFrame(anim);
  }

  document.addEventListener("visibilitychange", startCursorFrame);
  startCursorFrame();
  document
